...
func _ready() -> void:
	...
	if kill_area and not kill_area.is_connected("body_entered", Callable(self, "_on_kil_player_body_entered")):
		kill_area.connect("body_entered", Callable(self, "_on_kil_player_body_entered"))
...
func _can_see_player2() -> bool:
	return target and vision_ray_left.is_colliding() and vision_ray_left.get_collider() == target
	
func _can_see_player3() -> bool:
	return target and vision_ray_right.is_colliding() and vision_ray_right.get_collider() == target
...
func _on_kil_player_body_entered(body: Node) -> void:
	...
	if body.is_in_group("Player"):
		...
		get_tree().call_deferred("change_scene_to_file","res://enemy/kill_scene.tscn" )
